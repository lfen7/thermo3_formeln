...
\usepackage[a4paper, landscape, margin=1.5cm, tmargin=2cm, twocolumn]{geometry}
...
\usepackage{fancyhdr}		% headers
    \pagestyle{fancy}
    \lhead{Leo Fent, lfent@ethz.ch}
    \chead{Thermo III – Spassige Formeln zum auswendiglernen}
    \rhead{\thepage}
    % \cfoot{Corrections or comments to: lfent@ethz.ch}
